...
# To do Today - Django React TODO lists
...
- Create a copy of ``todotoday/settings/local.py.example``:  
  `cp todotoday/settings/local.py.example todotoday/settings/local.py` (remembering you should replace `todotoday` with your project's name!).
